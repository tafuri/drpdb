...
#define MEMBER(name, desc)  out += CSV::details::appendSeparator( #name );  
#define END_STRUCT()  ; if (out.back() == CSV::details::getSeparator()) out.pop_back(); out+="\n";}
